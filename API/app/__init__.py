...
from .routers import db_functions, login_router, inference, VDB_functions, arxiv_functions,vllm_build
...
app.include_router(vllm_build.router, prefix="/vllm_init", tags=["vllm_build"])
